...
images: ['/static/images/norman-gulfs.png']
authors: ['default']
---
...
<Image
  src="/static/images/norman-gulfs.png"
  alt="Norman's Gulfs model showing Execution and Evaluation between Conceptual model and Real world"
  width={1245}
  height={768}
